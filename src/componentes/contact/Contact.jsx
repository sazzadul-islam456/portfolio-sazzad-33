      ...
      <div className="contact__container container grid">
        <div className="contact__contact">
          ...
          <div className="contact__info">
            <div className="contact__card">
              <div className="bx bxl-messenger contact__card-icon"></div>

              <h3 className="contact__card-title">Email</h3>
              <span className="contact_card-data">
                sazzad.islam.608@gmail.com
              </span>
            ...
            <div className="contact__card">
              ...
              <span className="contact_card-data">01776424089</span>
        ...
        <div className="contact__contact">
          ...
          <form ref={form} onSubmit={sendEmail}>
            ...
            <div className="contact__from-div">
              <lable className="contact__from-tag">Mail</lable>
              <textarea
                name="email"
                type="email"
                id=""
            ...
            <div className="contact__from-div contact__from-area">
              <lable className="contact__from-tag">Project</lable>
              <textarea
                name="project"
                id=""
                cols="30"
